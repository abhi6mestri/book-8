...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `s_rent_order` WHERE CONCAT(`id`, `m_id`, `p_id`, `p_name`, `qty`, `price`, `seller_name`, `rent_from`, `rent_till`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `s_rent_order`";
    $search_result = filterTable($query);
}
